      ...
      <div class="container-custom py-8 sm:py-12">
        ...
        @if (successMessage()) {
          <div class="mb-6 p-4 rounded-lg bg-green-50 border border-green-200 text-green-700 text-sm">
            {{ successMessage() }}
            <button type="button" (click)="successMessage.set('')" class="ml-2 text-green-500 hover:text-green-700 focus-visible:ring-2 focus-visible:ring-green-400 outline-none rounded px-1" aria-label="Dismiss success" title="Dismiss success">✕</button>
          </div>
        }
                        ...
                        <tr class="border-b border-secondary-100 align-top">
                          ...
                          <td class="px-3 py-2 text-right">
                            <button type="button" (click)="deleteViewRow($index)"
                              class="px-2 py-1 rounded border border-red-200 bg-red-50 hover:bg-red-100 text-red-600 text-xs transition-colors focus-visible:ring-2 focus-visible:ring-red-400 outline-none"

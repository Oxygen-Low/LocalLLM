      ...
      <div class="container-custom py-8 sm:py-12">
        ...
        @if (successMessage()) {
          <div class="mb-6 p-4 rounded-lg bg-green-50 border border-green-200 text-green-700 text-sm">
            {{ successMessage() }}
            <button type="button" (click)="successMessage.set('')" class="ml-2 text-green-500 hover:text-green-700" aria-label="Dismiss success" title="Dismiss success">✕</button>
          </div>
        }
                      ...
                      @for (row of viewRows(); track $index) {
                        <tr class="border-b border-secondary-100 align-top">
                          ...
                          <td class="px-3 py-2 text-right">
                            <button type="button" (click)="deleteViewRow($index)"
        ...
        @if (currentStep() === 'configure') {
          <div class="max-w-2xl mx-auto mb-6">
            <div class="flex rounded-lg border border-secondary-200 bg-white overflow-hidden">
              <button type="button"                 (click)="datasetMode.set('generate')"
              ...
              <button type="button"                 (click)="datasetMode.set('import')"
                class="flex-1 px-4 py-3 text-sm font-medium transition-colors"
              ...
              <button type="button"                 (click)="datasetMode.set('queue')"
                class="flex-1 px-4 py-3 text-sm font-medium transition-colors"
              ...
              <button type="button"                 (click)="datasetMode.set('refine')"
                class="flex-1 px-4 py-3 text-sm font-medium transition-colors"
            ...
            <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6 space-y-6">
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  <button type="button"                     (click)="generateDatasetType = 'standard'"
                  ...
                  <button type="button"                     (click)="generateDatasetType = 'post-training'"
                    class="text-left p-3 rounded-lg border-2 transition-all"
              ...
              <!-- Generate button -->
              <button type="button"                 (click)="generateDataset()"
        ...
        @if (currentStep() === 'configure' && datasetMode() === 'import') {
          <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6 space-y-6">
              ...
              <!-- Import button -->
              <button type="button"                 (click)="importFromHuggingFace()"
            ...
            <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6 space-y-4">
              ...
              <div>
                ...
                @if (isLoadingProviders()) {
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    @for (p of availableProviders(); track p.id) {
                      <button type="button"                         (click)="selectQueueProvider(p)"
                        class="text-left p-3 rounded-lg border transition-all"
            ...
            <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6 space-y-4">
              ...
              <div>
                ...
                @if (isLoadingProviders()) {
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    @for (p of availableProviders(); track p.id) {
                      <button type="button"                         (click)="selectRefineProvider(p)"
                        class="text-left p-3 rounded-lg border transition-all"
              ...
              <!-- Add to queue button -->
              <button type="button"                 (click)="addRefineToQueue()"
          ...
          <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <!-- Download -->
                <button type="button"                   (click)="downloadDataset()"
                ...
                <div class="space-y-3">
                  @if (!showSaveForm()) {
                    <button type="button"                       (click)="showSaveForm.set(true)"
                    ...
                    <div class="p-4 rounded-lg border border-green-200 bg-green-50 space-y-3">
                      ...
                      <div class="flex gap-2">
                        <button type="button"                           (click)="saveDataset()"
                        ...
                        <button type="button"                           (click)="showSaveForm.set(false)"

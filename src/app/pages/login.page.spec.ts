...
describe('LoginPageComponent', () => {
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [LoginPageComponent, RouterModule.forRoot([])],
      providers: [
        AuthService,
  ...
  it('should update aria-label on toggle button when password is shown', () => {
    const fixture = TestBed.createComponent(LoginPageComponent);
    fixture.detectChanges();
    const compiled = fixture.nativeElement as HTMLElement;
    const toggleButton = compiled.querySelector('button[aria-label="Show password"]') as HTMLButtonElement;
    toggleButton.click();
    fixture.detectChanges();
    const updatedButton = compiled.querySelector('button[aria-label="Hide password"]');

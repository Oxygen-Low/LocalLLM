      ...
      <div class="container-custom py-10">
        ...
        <div class="flex items-center justify-between mb-8 flex-wrap gap-4">
          ...
          @if (currentView() === 'list') {
            <div class="flex gap-2 flex-wrap">
              <button type="button" (click)="showImportGitHub()" class="btn-secondary text-sm">
                ↓ Import from GitHub
              </button>
        ...
        @if (errorMessage()) {
          <div class="mb-6 p-4 rounded-lg bg-red-50 border border-red-200 text-red-700 text-sm">
            {{ errorMessage() }}
            <button type="button" (click)="errorMessage.set('')" class="ml-2 text-red-500 hover:text-red-700 focus-visible:ring-2 focus-visible:ring-red-400 outline-none rounded px-1" aria-label="Dismiss error" title="Dismiss error">✕</button>
          </div>
        }
        ...
        @if (successMessage()) {
          <div class="mb-6 p-4 rounded-lg bg-green-50 border border-green-200 text-green-700 text-sm">
            {{ successMessage() }}
            <button type="button" (click)="successMessage.set('')" class="ml-2 text-green-500 hover:text-green-700 focus-visible:ring-2 focus-visible:ring-green-400 outline-none rounded px-1" aria-label="Dismiss success message" title="Dismiss success message">✕</button>
          </div>
        }
            ...
            @if (isLoading()) {
              ...
              <div class="text-center py-16 bg-white rounded-xl border border-secondary-200 shadow-sm">
                ...
                <div class="flex justify-center gap-3">
                  <button type="button" (click)="showImportGitHub()" class="btn-secondary text-sm">↓ Import from GitHub</button>
                  <button type="button" (click)="showCreate()" class="btn-primary text-sm">+ New Repository</button>
                </div>
              </div>
            } @else {
            ...
            <div class="max-w-lg">
              ...
              <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6">
                ...
                <div class="space-y-4">
                  ...
                  <button type="button" (click)="doCreate()" [disabled]="isCreating() || !createName.trim()"
            ...
            <div class="max-w-lg">
              ...
              <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6">
                ...
                <div class="space-y-4">
                  ...
                  <button type="button" (click)="doImport()" [disabled]="isImporting() || !importUrl.trim()"
                          class="btn-primary w-full disabled:opacity-50">
            ...
            <div class="max-w-lg">
              ...
              <div class="bg-white rounded-xl border border-secondary-200 shadow-sm p-6">
                ...
                <div class="space-y-4">
                  ...
                  <button type="button" (click)="doExport()" [disabled]="isExporting()"
                          class="btn-primary w-full disabled:opacity-50">

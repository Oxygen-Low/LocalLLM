      ...
      <div class="container-custom py-10">
        ...
        @if (errorMessage()) {
          <div class="mb-6 p-4 rounded-lg bg-red-50 border border-red-200 text-red-700 text-sm flex items-center justify-between">
            ...
            <button type="button" (click)="errorMessage.set('')" class="text-red-500 hover:text-red-700 focus-visible:ring-2 focus-visible:ring-red-400 outline-none rounded px-1" aria-label="Dismiss error" title="Dismiss error">✕</button>
          </div>
        }
        ...
        @if (successMessage()) {
          <div class="mb-6 p-4 rounded-lg bg-green-50 border border-green-200 text-green-700 text-sm flex items-center justify-between">
            ...
            <button type="button" (click)="successMessage.set('')" class="text-green-500 hover:text-green-700 focus-visible:ring-2 focus-visible:ring-green-400 outline-none rounded px-1" aria-label="Dismiss success message" title="Dismiss success message">✕</button>
          </div>
        }

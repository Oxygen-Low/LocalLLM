                  ...
                  <div class="flex items-start justify-between gap-4">
                    ...
                    <div class="flex flex-col gap-2">
                      <div class="flex gap-2">
                        <button (click)="showEdit(persona)" class="p-2 rounded-lg border border-secondary-200 hover:bg-secondary-50 transition-colors text-secondary-600" title="Edit Persona">
                          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                          </svg>
                        </button>
                        <button (click)="confirmDelete(persona)" class="p-2 rounded-lg border border-red-100 hover:bg-red-50 transition-colors text-red-500" title="Delete Persona">
                          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      @if (defaultPersonaId() !== persona.id) {
                        <button (click)="makeDefault(persona.id)" class="text-[11px] font-medium text-primary-600 hover:text-primary-800 transition-colors text-right opacity-0 group-hover:opacity-100">
                          Set as default
                        </button>
                      } @else {
                        <button (click)="makeDefault(null)" class="text-[11px] font-medium text-secondary-400 hover:text-secondary-600 transition-colors text-right opacity-0 group-hover:opacity-100">
                          Clear default
                        </button>
                      }
                    </div>

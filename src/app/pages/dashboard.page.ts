  ...
  readonly allApps: AIApp[] = [
    {
      ...
      name: 'apps.general-assistant.name',
      description: 'apps.general-assistant.description',
      icon: '🤖',
      category: 'apps.category.assistant',
      color: 'blue',
    },
    {
      id: 'coding-agent',
      name: 'apps.coding-agent.name',
      description: 'apps.coding-agent.description',
      icon: '💻',
      category: 'apps.category.agent',
      color: 'purple',
      risky: true,
    },
    {
      id: 'repositories',
      name: 'apps.repositories.name',
      description: 'apps.repositories.description',
      icon: '📦',
      category: 'apps.category.storage',
      color: 'green',
      risky: true,
    },
    {
    ...
    {
      id: 'train-llm',
      name: 'apps.train-llm.name',
      description: 'apps.train-llm.description',
      icon: '🎓',
    ...
    {
      id: 'books',
      name: 'apps.books.name',
      description: 'apps.books.description',
      icon: '📚',
      category: 'apps.category.creative',
      color: 'blue',
    },

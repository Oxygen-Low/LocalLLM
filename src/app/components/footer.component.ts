      ...
      <div class="container-custom py-8 sm:py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="https://github.com/Oxygen-Low/LocalLLM" target="_blank" rel="noopener noreferrer" class="text-sm text-muted hover:text-primary-600 transition-colors">About</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a routerLink="/terms" class="text-sm text-muted hover:text-primary-600 transition-colors">Terms</a></li>

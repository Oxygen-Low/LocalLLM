...
const translations: TranslationDictionary = {
  ...
  'books.subtitle': {
    en: 'Practice your writing skills in themed spaces.',
    ko: '테마 공간에서 글쓰기 실력을 연습하세요.',
    ja: 'テーマ別のスペースで執筆スキルを練習しましょう。',
    ru: 'Практикуйте навыки письма в тематических пространствах.',
  },
  'books.nav.library': {
    en: 'Library',
    ko: '라이브러리',
  ...
  'books.list.deleteSpace': {
    en: 'Delete space',
    ko: '공간 삭제',
    ja: 'スペースを削除',
    ru: 'Удалить пространство',
  },
  'books.list.noDescription': {
    en: 'No description provided.',
    ko: '설명이 제공되지 않았습니다.',
    ja: '説明はありません。',
    ru: 'Описание отсутствует.',
  },
  'books.list.booksCount': {
    en: 'books',
    ko: '권',
    ja: '冊',
    ru: 'книг',
  },
  'books.list.enterSpace': {
    en: 'Enter Space',
    ko: '공간 입장',
    ja: 'スペースに入る',
    ru: 'Войти в пространство',
  },
  'books.list.empty.title': {
    en: 'No writing spaces yet',
    ko: '아직 글쓰기 공간이 없습니다',
    ja: '執筆スペースがまだありません',
    ru: 'Пока нет пространств для письма',
  },
  'books.list.empty.subtitle': {
    en: 'Create a space to start organizing your books and practice sessions.',
    ko: '공간을 만들어 책과 연습 세션을 관리해 보세요.',
    ja: 'スペースを作成して、本や練習セッションの整理を始めましょう。',
    ru: 'Создайте пространство, чтобы начать организовывать свои книги и практические занятия.',
  },
  'books.list.empty.button': {
    en: 'Create your first space',
    ko: '첫 번째 공간 만들기',
    ja: '最初のスペースを作成する',
    ru: 'Создать первое пространство',
  },
  'books.create.title': {
    en: 'Create New Space',
    ko: '새 공간 만들기',
  ...
  'books.create.name': {
    ...
    ko: '공간 제목',
    ja: 'スペース名',
    ru: 'Название пространства',
  },
  'books.create.namePlaceholder': {
    en: 'e.g. My Fantasy World',
    ko: '예: 나의 판타지 세계',
    ja: '例: 私のファンタジーの世界',
    ru: 'например: Мой фэнтези-мир',
  },
  'books.create.inspiration': {
    en: 'Inspiration (Optional)',
    ko: '영감 (선택사항)',
    ja: 'インスピレーション（任意）',
    ru: 'Вдохновение (необязательно)',
  },
  'books.create.inspirationPlaceholder': {
    en: 'e.g. Lord of the Rings, Harry Potter',
    ko: '예: 반지의 제왕, 해리 포터',
    ja: '例: ロード・オブ・ザ・リング、ハリー・ポッター',
    ru: 'например: Властелин колец, Гарри Поттер',
  },
  'books.create.inspirationHint': {
    en: 'Characters and tasks will be themed after this inspiration.',
    ko: '캐릭터와 과제는 이 영감을 바탕으로 테마가 정해집니다.',
    ja: 'キャラクターやタスクはこのインスピレーションに基づいたテーマになります。',
    ru: 'Персонажи и задачи будут тематически связаны с этим вдохновением.',
  },
  'books.create.description': {
    en: 'Description',
    ko: '설명',
    ja: '説明',
    ru: 'Описание',
  },
  'books.create.descriptionPlaceholder': {
    en: 'Describe the world, tone, or specific goals for this space...',
    ko: '세계관, 분위기 또는 이 공간의 구체적인 목표를 설명하세요...',
    ja: '世界観、トーン、またはこのスペースの具体的な目標を説明してください...',
    ru: 'Опишите мир, тон или конкретные цели этого пространства...',
  },
  'books.create.cancel': {
    en: 'Cancel',
    ko: '취소',
  ...
  'books.create.creating': {
    en: 'Creating...',
    ko: '생성 중...',
    ja: '作成中...',
    ru: 'Создание...',
  },
  'books.detail.inspiredBy': {
    en: 'Inspired by',
    ko: '영감:',
    ja: 'インスピレーション:',
    ru: 'Вдохновлено',
  },
  'books.detail.noDescription': {
    en: 'No description.',
    ko: '설명 없음.',
    ja: '説明なし。',
    ru: 'Нет описания.',
  },
  'books.detail.referenceBooks': {
    en: 'Reference Books',
    ko: '참고 도서',
    ja: '参考書籍',
    ru: 'Книги для справки',
  },
  'books.detail.deleteBook': {
    en: 'Delete book',
    ko: '도서 삭제',
    ja: '本を削除',
    ru: 'Удалить книгу',
  },
  'books.detail.noBooks': {
    en: 'No books uploaded yet.',
    ko: '아직 업로드된 책이 없습니다.',
    ja: '本はまだアップロードされていません。',
    ru: 'Книги еще не загружены.',
  },
  'books.detail.uploadBook': {
    en: 'Upload Book',
    ko: '도서 업로드',
    ja: '本をアップロード',
    ru: 'Загрузить книгу',
  },
  'books.detail.uploadHint': {
    en: 'Max 10MB. Supports .txt and .md files.',
    ko: '최대 10MB. .txt 및 .md 파일을 지원합니다.',
    ja: '最大10MB。.txtおよび.mdファイルをサポート。',
    ru: 'Макс. 10 МБ. Поддерживаются файлы .txt и .md.',
  },
  'books.practice.title': {
    en: 'Practice Session',
    ko: '연습 세션',
    ja: '練習セッション',
    ru: 'Практическое занятие',
  },
  'books.practice.subtitle': {
    en: "Generate a writing task based on your space's context and books.",
    ko: '공간의 문맥과 책을 바탕으로 글쓰기 과제를 생성합니다.',
    ja: 'スペースの文脈や本に基づいて執筆タスクを生成します。',
    ru: 'Создайте задачу для письма на основе контекста вашего пространства и книг.',
  },
  'books.practice.question': {
    en: 'What would you like to write?',
    ko: '무엇을 쓰고 싶으신가요?',
    ja: '何を書きたいですか？',
    ru: 'Что бы вы хотели написать?',
  },
  'books.practice.types.book': {
    en: 'Book',
    ko: '도서',
    ja: '本',
    ru: 'Книга',
  },
  'books.practice.types.paragraph': {
    en: 'Paragraph',
    ko: '단락',
    ja: '段落',
    ru: 'Абзац',
  },
  'books.practice.types.sentence': {
    en: 'Sentence',
    ko: '문장',
    ja: '文',
    ru: 'Предложение',
  },
  'books.practice.sampleTitle': {
    en: 'Auto-generate sample',
    ko: '샘플 자동 생성',
    ja: 'サンプルを自動生成',
    ru: 'Автогенерация примера',
  },
  'books.practice.sampleSubtitle': {
    en: 'Generate a few sentences to set the mood.',
    ko: '분위기를 잡기 위한 몇 문장을 생성합니다.',
    ja: 'ムードを高めるための数文を生成します。',
    ru: 'Сгенерируйте несколько предложений, чтобы задать настроение.',
  },
  'books.practice.creating': {
    en: 'Preparing your task...',
    ko: '과제 준비 중...',
    ja: 'タスクを準備中...',
    ru: 'Подготовка задачи...',
  },
  'books.practice.submit': {
    en: 'Start Writing',
    ko: '쓰기 시작',
    ja: '執筆を開始',
    ru: 'Начать писать',
  },
  'books.writing.characters': {
    en: 'The Characters',
    ko: '캐릭터',
    ja: 'キャラクター',
    ru: 'Персонажи',
  },
  'books.writing.setting': {
    en: 'Setting',
    ko: '배경',
    ja: '設定',
    ru: 'Сеттинг',
  ...
  'books.writing.editor': {
    en: 'Editor',
    ko: '편집기',
    ja: 'エディタ',
    ru: 'Редактор',
  },
  'books.writing.charsCount': {
    en: 'characters',
    ko: '자',
    ja: '文字',
    ru: 'символов',
  },
  'books.writing.sampleStart': {
    en: 'Sample Start',
    ko: '샘플 시작',
    ja: 'サンプルの開始',
    ru: 'Начало примера',
  },
  'books.writing.placeholder': {
    en: 'Start writing your scene here...',
    ko: '여기에 장면을 쓰기 시작하세요...',
    ja: 'ここにシーンを書き始めてください...',
    ru: 'Начните писать свою сцену здесь...',
  },
  'books.writing.evaluating': {
    en: 'Evaluating...',
    ko: '평가 중...',
    ja: '評価中...',
    ru: 'Оценка...',
  },
  'books.writing.submit': {
    en: 'Submit for Evaluation',
    ko: '평가 제출',
    ja: '評価のために提出',
    ru: 'Отправить на оценку',
  },
  'books.evaluation.title': {
    en: 'Review Complete',
    ko: '검토 완료',
    ja: 'レビュー完了',
    ru: 'Обзор завершен',
  },
  'books.evaluation.subtitle': {
    en: "Here's how you did on your practice task.",
    ko: '연습 과제에 대한 결과입니다.',
    ja: '練習タスクの結果は以下の通りです。',
    ru: 'Вот как вы справились с практической задачей.',
  },
  'books.evaluation.overall': {
    en: 'Overall Impression',
    ko: '전체적인 인상',
    ja: '全体的な印象',
    ru: 'Общее впечатление',
  },
  'books.evaluation.suggestions': {
    en: 'Key Suggestions',
    ko: '주요 제안',
    ja: '主な提案',
    ru: 'Основные предложения',
  },
  'books.evaluation.analysis': {
    en: 'Detailed Analysis',
    ko: '상세 분석',
    ja: '詳細な分析',
    ru: 'Подробный анализ',
  },
  'books.evaluation.types.word': {
    en: 'WORD',
    ko: '단어',
    ja: '単語',
    ru: 'СЛОВО',
  },
  'books.evaluation.types.sentence': {
    en: 'SENTENCE',
    ko: '문장',
    ja: '文',
    ru: 'ПРЕДЛОЖЕНИЕ',
  },
  'books.evaluation.types.paragraph': {
    en: 'PARAGRAPH',
    ko: '단락',
    ja: '段落',
    ru: 'АБЗАЦ',
  },
  'books.evaluation.back': {
    en: 'Back to Editor',
    ko: '편집기로 돌아가기',
    ja: 'エディタに戻る',
    ru: 'Назад к редактору',
  },
  'books.evaluation.finish': {
    en: 'Finish & Done',
    ko: '완료 및 종료',
    ja: '終了して完了',
    ru: 'Завершить',
  },
  'books.errors.loadSpaces': {
    en: 'Failed to load writing spaces.',
    ko: '글쓰기 공간을 불러오지 못했습니다.',
    ja: '執筆スペースの読み込みに失敗しました。',
    ru: 'Не удалось загрузить пространства для письма.',
  },
  'books.errors.createSpace': {
    en: 'Failed to create space.',
    ko: '공간을 만들지 못했습니다.',
    ja: 'スペースの作成に失敗しました。',
    ru: 'Не удалось создать пространство.',
  },
  'books.errors.deleteSpace': {
    en: 'Failed to delete space.',
    ko: '공간을 삭제하지 못했습니다.',
    ja: 'スペースの削除に失敗しました.',
    ru: 'Не удалось удалить пространство.',
  },
  'books.errors.fileTooLarge': {
    en: 'File too large. Maximum size is 10MB.',
    ko: '파일이 너무 큽니다. 최대 크기는 10MB입니다.',
    ja: 'ファイルが大きすぎます。最大サイズは10MBです。',
    ru: 'Файл слишком велик. Максимальный размер — 10 МБ.',
  },
  'books.errors.invalidFileType': {
    en: 'Invalid file type. Only .txt and .md are allowed.',
    ko: '잘못된 파일 형식입니다. .txt 및 .md만 허용됩니다.',
    ja: '無効なファイル形式です。.txtと.mdのみが許可されます。',
    ru: 'Неверный тип файла. Разрешены только .txt и .md.',
  },
  ...
  'books.errors.deleteBook': {
    en: 'Failed to delete book.',
    ko: '도서 삭제에 실패했습니다.',
    ja: '本の削除に失敗しました。',
    ru: 'Не удалось удалить книгу.',
  },
  'books.errors.generateTask': {
    en: 'Failed to generate writing task. Check your AI provider settings.',
    ko: '글쓰기 과제를 생성하지 못했습니다. AI 제공업체 설정을 확인하세요.',
    ja: '執筆タスクの生成に失敗しました。AIプロバイダーの設定を確認してください。',
    ru: 'Не удалось создать задачу для письма. Проверьте настройки провайдера ИИ.',
  },
  'books.errors.evaluate': {
    en: 'Evaluation failed. Please try again.',
    ko: '평가에 실패했습니다. 다시 시도해 주세요.',
    ja: '評価に失敗しました。もう一度やり直してください。',
    ru: 'Ошибка оценки. Пожалуйста, попробуйте еще раз.',
  },
  'books.confirm.deleteSpace': {
    en: 'Are you sure you want to delete this space and all its books?',
    ko: '이 공간과 모든 책을 삭제하시겠습니까?',
    ja: 'このスペースとその中のすべての本を削除してもよろしいですか？',
    ru: 'Вы уверены, что хотите удалить это пространство и все книги в нем?',
  },
  'books.confirm.deleteBook': {
    en: 'Delete this book from the space?',
    ko: '이 공간에서 이 책을 삭제하시겠습니까?',
    ja: 'このスペースからこの本を削除しますか？',
    ru: 'Удалить эту книгу из пространства?',
  },
  'localFix.title': {
    en: '🔧 Local Fix',
    ko: '🔧 로컬 수리',
